 ...
 * @author Kabir Khan
 */
public class ExtendendChoiceCallbackConfiguration extends AuthenticationConfiguration {
    private final int responseChoice;

    public ExtendendChoiceCallbackConfiguration(AuthenticationConfiguration parent, int responseChoice) {
        super(parent);
